...
module.exports = function(app)
{
	...
	app.delete('/api/images/:imageId',auth.ensureAuthenticated,auth.image.hasAuthorization,images.destroy);
	...
	//	design-rule
	var designRules = require('../controllers/design-rules');
	app.get('/api/design-rules',designRules.all);
